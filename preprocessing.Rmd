...
growth_r[which(growth_r$mom_weight_previous_c < 1 &
                 growth_r$mom_weight_previous_c > -1), ]
summary(growth_r$mom_weight_previous_c)

mean(growth$mom_wt_tx, na.rm = TRUE)

1/ (0.08333862^2)

mean(growth$mom_weight_previous, na.rm = TRUE)

plot(growth$mom_weight_previous, growth$birth_weight)
...
growth <- growth |>
  ...
  mutate(parity_f = relevel(as.factor(parity_), ref = "0")) |>
